"""
Django settings for soen341app project.
...
WSGI_APPLICATION = 'soen341app.wsgi.application'
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {
        'NAME': 'soen341app.custom_password_validator.CustomPasswordValidator',
    },
]
